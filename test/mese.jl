function mese1()
    ...
    rephaser = GradientSpoiling([0], [0], [0], 0)
    crusher = GradientSpoiling(0, 0, 0, 0)
    spoiler = GradientSpoiling(0, 0, 0, 0)
    mese1! = MESEBlochSim(3000, 10, 32, rfex, rfref, rephaser, crusher, spoiler)
    mese2! = MESEBlochSim(3000, 10, 32, rfex, rfref, rephaser, crusher, nothing)
