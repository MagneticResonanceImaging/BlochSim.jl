...
using BlochSim: excite!, spoil # spoil! todo
...
zlist = range(-2, 2, 401) # z positions (cm)
...
using BlochSim: AbstractSpin, applydynamics!
...
todo: belongs in src
"""
function refocus!(spin::AbstractSpin, args...)
    (A, B) = spoil(spin, args...)
    BtoM = copy(spin.M)
